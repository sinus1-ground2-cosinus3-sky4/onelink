...
function useDialogContext(component) {
  let context = (0, import_vue21.inject)(DialogContext, null);
  if (context === null) {
...
var Dialog = (0, import_vue21.defineComponent)({
  name: "Dialog",
  inheritAttrs: false,
  props: {
    as: { type: [Object, String], default: "div" },
  ...
  setup(props, { emit, attrs, slots, expose }) {
    var _a;
    let ready = (0, import_vue21.ref)(false);
    (0, import_vue21.onMounted)(() => {
      ready.value = true;
    });
    let nestedDialogCount = (0, import_vue21.ref)(0);
    let usesOpenClosedState = useOpenClosed();
    let open = (0, import_vue21.computed)(() => {
    ...
    let containers = (0, import_vue21.ref)(/* @__PURE__ */ new Set());
    let internalDialogRef = (0, import_vue21.ref)(null);
    let mainTreeNode = (0, import_vue21.ref)(null);
    let ownerDocument = (0, import_vue21.computed)(() => getOwnerDocument(internalDialogRef));
    ...
    let dialogState = (0, import_vue21.computed)(() => !ready.value ? 1 /* Closed */ : open.value ? 0 /* Open */ : 1 /* Closed */);
    let enabled = (0, import_vue21.computed)(() => dialogState.value === 0 /* Open */);
    let hasNestedDialogs = (0, import_vue21.computed)(() => nestedDialogCount.value > 1);
    let hasParentDialog = (0, import_vue21.inject)(DialogContext, null) !== null;
    let position = (0, import_vue21.computed)(() => !hasNestedDialogs.value ? "leaf" : "parent");
    useInertOthers(internalDialogRef, (0, import_vue21.computed)(() => hasNestedDialogs.value ? enabled.value : false));
    useStackProvider({
      type: "Dialog",
      enabled: (0, import_vue21.computed)(() => dialogState.value === 0 /* Open */),
    ...
    let describedby = useDescriptions({
      ...
      slot: (0, import_vue21.computed)(() => ({ open: open.value }))
    });
    let titleId = (0, import_vue21.ref)(null);
    let api = {
      titleId,
      panelRef: (0, import_vue21.ref)(null),
      dialogState,
      setTitleId(id2) {
    ...
    (0, import_vue21.provide)(DialogContext, api);
    ...
    useOutsideClick(() => resolveAllowedContainers(), (_event, target) => {
      api.close();
      (0, import_vue21.nextTick)(() => target == null ? void 0 : target.focus());
    }, (0, import_vue21.computed)(() => dialogState.value === 0 /* Open */ && !hasNestedDialogs.value));
    ...
    (0, import_vue21.watchEffect)((onInvalidate) => {
      ...
      if (isIOS()) {
        ...
        d.addEventListener(owner, "click", (e) => {
        ...
        d.addEventListener(owner, "touchmove", (e) => {
    ...
    return () => {
      ...
      return (0, import_vue21.h)(ForcePortalRoot, { force: true }, () => [
        (0, import_vue21.h)(Portal, () => (0, import_vue21.h)(PortalGroup, { target: internalDialogRef.value }, () => (0, import_vue21.h)(ForcePortalRoot, { force: false }, () => (0, import_vue21.h)(FocusTrap, {
          initialFocus,
          containers,
        ...
        (0, import_vue21.h)(Hidden, { features: 4 /* Hidden */, ref: mainTreeNode })
      ]);
    };
  }
});
var DialogOverlay = (0, import_vue21.defineComponent)({
  name: "DialogOverlay",
  props: {
    as: { type: [Object, String], default: "div" },
...
var DialogBackdrop = (0, import_vue21.defineComponent)({
  name: "DialogBackdrop",
  props: {
    as: { type: [Object, String], default: "div" },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let internalBackdropRef = (0, import_vue21.ref)(null);
    ...
    return () => {
      ...
      return (0, import_vue21.h)(ForcePortalRoot, { force: true }, () => (0, import_vue21.h)(Portal, () => render({
        ourProps,
        theirProps: { ...attrs, ...theirProps },
        slot: { open: api.dialogState.value === 0 /* Open */ },
        attrs,
...
var DialogPanel = (0, import_vue21.defineComponent)({
  name: "DialogPanel",
  props: {
    as: { type: [Object, String], default: "div" },
...
var DialogTitle = (0, import_vue21.defineComponent)({
  name: "DialogTitle",
  props: {
  ...
  setup(props, { attrs, slots }) {
    ...
    (0, import_vue21.onMounted)(() => {
      ...
      (0, import_vue21.onUnmounted)(() => api.setTitleId(null));
    });
    return () => {
      let { id: id2, ...theirProps } = props;
      let ourProps = { id: id2 };
...
function useDisclosureContext(component) {
  let context = (0, import_vue22.inject)(DisclosureContext, null);
  if (context === null) {
...
function useDisclosurePanelContext() {
  return (0, import_vue22.inject)(DisclosurePanelContext, null);
}
var Disclosure = (0, import_vue22.defineComponent)({
  name: "Disclosure",
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  setup(props, { slots, attrs }) {
    let disclosureState = (0, import_vue22.ref)(props.defaultOpen ? 0 /* Open */ : 1 /* Closed */);
    let panelRef = (0, import_vue22.ref)(null);
    let buttonRef = (0, import_vue22.ref)(null);
    let api = {
      buttonId: (0, import_vue22.ref)(null),
      panelId: (0, import_vue22.ref)(null),
      disclosureState,
      panel: panelRef,
      button: buttonRef,
      toggleDisclosure() {
    ...
    (0, import_vue22.provide)(DisclosureContext, api);
    useOpenClosedProvider((0, import_vue22.computed)(() => {
...
var DisclosureButton = (0, import_vue22.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let isWithinPanel = (0, import_vue22.computed)(() => panelContext === null ? false : panelContext.value === api.panelId.value);
    let internalButtonRef = (0, import_vue22.ref)(null);
    ...
    let type = useResolveButtonType((0, import_vue22.computed)(() => ({ as: props.as, type: attrs.type })), internalButtonRef);
    function handleClick() {
      var _a;
      if (props.disabled)
        return;
...
var DisclosurePanel = (0, import_vue22.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    (0, import_vue22.provide)(DisclosurePanelContext, api.panelId);
    let usesOpenClosedState = useOpenClosed();
...
function useListboxContext(component) {
  let context = (0, import_vue23.inject)(ListboxContext, null);
  if (context === null) {
...
var Listbox = (0, import_vue23.defineComponent)({
  name: "Listbox",
  emits: { "update:modelValue": (_value) => true },
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  inheritAttrs: false,
  setup(props, { slots, attrs, emit }) {
    let listboxState = (0, import_vue23.ref)(1 /* Closed */);
    let labelRef = (0, import_vue23.ref)(null);
    let buttonRef = (0, import_vue23.ref)(null);
    let optionsRef = (0, import_vue23.ref)(null);
    let options = (0, import_vue23.ref)([]);
    let searchQuery = (0, import_vue23.ref)("");
    let activeOptionIndex = (0, import_vue23.ref)(null);
    ...
    let mode = (0, import_vue23.computed)(() => props.multiple ? 1 /* Multi */ : 0 /* Single */);
    let [value, theirOnChange] = useControllable((0, import_vue23.computed)(() => props.modelValue === void 0 ? match(mode.value, {
      [1 /* Multi */]: [],
      [0 /* Single */]: void 0
    }) : props.modelValue), (value2) => emit("update:modelValue", value2), (0, import_vue23.computed)(() => props.defaultValue));
    let api = {
      listboxState,
      value,
      mode,
      ...
      orientation: (0, import_vue23.computed)(() => props.horizontal ? "horizontal" : "vertical"),
      labelRef,
      buttonRef,
      optionsRef,
      ...
      select(value2) {
        ...
        theirOnChange(match(mode.value, {
          [0 /* Single */]: () => value2,
          [1 /* Multi */]: () => {
            let copy = (0, import_vue23.toRaw)(api.value.value).slice();
            let raw = (0, import_vue23.toRaw)(value2);
            let idx = copy.findIndex((value3) => api.compare(raw, (0, import_vue23.toRaw)(value3)));
            if (idx === -1) {
              copy.push(raw);
            } else {
              copy.splice(idx, 1);
    ...
    }, (0, import_vue23.computed)(() => listboxState.value === 0 /* Open */));
    (0, import_vue23.provide)(ListboxContext, api);
    useOpenClosedProvider((0, import_vue23.computed)(() => match(listboxState.value, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })));
    let form = (0, import_vue23.computed)(() => {
      var _a;
      return (_a = dom(buttonRef)) == null ? void 0 : _a.closest("form");
    });
    (0, import_vue23.onMounted)(() => {
      (0, import_vue23.watch)([form], () => {
        if (!form.value)
          return;
        if (props.defaultValue === void 0)
          return;
    ...
    return () => {
      ...
      return (0, import_vue23.h)(import_vue23.Fragment, [
        ...name != null && value.value != null ? objectToFormEntries({ [name]: value.value }).map(([name2, value2]) => (0, import_vue23.h)(Hidden, compact({
          features: 4 /* Hidden */,
          key: name2,
          as: "input",
          type: "hidden",
...
var ListboxLabel = (0, import_vue23.defineComponent)({
  name: "ListboxLabel",
  props: {
    as: { type: [Object, String], default: "label" },
...
var ListboxButton = (0, import_vue23.defineComponent)({
  name: "ListboxButton",
  props: {
    as: { type: [Object, String], default: "button" },
...
var ListboxOptions = (0, import_vue23.defineComponent)({
  name: "ListboxOptions",
  props: {
    as: { type: [Object, String], default: "ul" },
    static: { type: Boolean, default: false },
...
var ListboxOption = (0, import_vue23.defineComponent)({
  name: "ListboxOption",
  props: {
    as: { type: [Object, String], default: "li" },
    value: {
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let internalOptionRef = (0, import_vue23.ref)(null);
    expose({ el: internalOptionRef, $el: internalOptionRef });
    ...
    let selected = (0, import_vue23.computed)(() => match(api.mode.value, {
      [0 /* Single */]: () => api.compare((0, import_vue23.toRaw)(api.value.value), (0, import_vue23.toRaw)(props.value)),
      [1 /* Multi */]: () => (0, import_vue23.toRaw)(api.value.value).some((value) => api.compare((0, import_vue23.toRaw)(value), (0, import_vue23.toRaw)(props.value)))
    }));
    let isFirstSelected = (0, import_vue23.computed)(() => {
      return match(api.mode.value, {
        [1 /* Multi */]: () => {
          var _a;
          let currentValues = (0, import_vue23.toRaw)(api.value.value);
          return ((_a = api.options.value.find((option) => currentValues.some((value) => api.compare((0, import_vue23.toRaw)(value), (0, import_vue23.toRaw)(option.dataRef.value))))) == null ? void 0 : _a.id) === props.id;
        },
    ...
    (0, import_vue23.onMounted)(() => api.registerOption(props.id, dataRef));
    (0, import_vue23.onUnmounted)(() => api.unregisterOption(props.id));
    (0, import_vue23.onMounted)(() => {
      (0, import_vue23.watch)([api.listboxState, selected], () => {
        if (api.listboxState.value !== 0 /* Open */)
          return;
        if (!selected.value)
          return;
...
function useMenuContext(component) {
  let context = (0, import_vue24.inject)(MenuContext, null);
  if (context === null) {
...
var Menu = (0, import_vue24.defineComponent)({
  name: "Menu",
  props: { as: { type: [Object, String], default: "template" } },
  setup(props, { slots, attrs }) {
    let menuState = (0, import_vue24.ref)(1 /* Closed */);
    let buttonRef = (0, import_vue24.ref)(null);
    let itemsRef = (0, import_vue24.ref)(null);
    let items = (0, import_vue24.ref)([]);
    let searchQuery = (0, import_vue24.ref)("");
    let activeItemIndex = (0, import_vue24.ref)(null);
    let activationTrigger = (0, import_vue24.ref)(1 /* Other */);
    function adjustOrderedState(adjustment = (i) => i) {
    ...
    }, (0, import_vue24.computed)(() => menuState.value === 0 /* Open */));
    (0, import_vue24.provide)(MenuContext, api);
    useOpenClosedProvider((0, import_vue24.computed)(() => match(menuState.value, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })));
    return () => {
...
var MenuButton = (0, import_vue24.defineComponent)({
  name: "MenuButton",
  props: {
    disabled: { type: Boolean, default: false },
    as: { type: [Object, String], default: "button" },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let type = useResolveButtonType((0, import_vue24.computed)(() => ({ as: props.as, type: attrs.type })), api.buttonRef);
    return () => {
      var _a;
...
var MenuItems = (0, import_vue24.defineComponent)({
  name: "MenuItems",
  props: {
    as: { type: [Object, String], default: "div" },
    static: { type: Boolean, default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let searchDebounce = (0, import_vue24.ref)(null);
    expose({ el: api.itemsRef, $el: api.itemsRef });
    useTreeWalker({
      container: (0, import_vue24.computed)(() => dom(api.itemsRef)),
      enabled: (0, import_vue24.computed)(() => api.menuState.value === 0 /* Open */),
      accept(node) {
    ...
    function handleKeyDown(event) {
      ...
      switch (event.key) {
        ...
        case "Tab" /* Tab */:
          ...
          event.stopPropagation();
          api.closeMenu();
          (0, import_vue24.nextTick)(() => focusFrom(dom(api.buttonRef), event.shiftKey ? 2 /* Previous */ : 4 /* Next */));
          break;
        default:
          if (event.key.length === 1) {
            api.search(event.key);
...
var MenuItem = (0, import_vue24.defineComponent)({
  name: "MenuItem",
  inheritAttrs: false,
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    (0, import_vue24.onMounted)(() => api.registerItem(props.id, dataRef));
    (0, import_vue24.onUnmounted)(() => api.unregisterItem(props.id));
...
function usePopoverContext(component) {
  let context = (0, import_vue25.inject)(PopoverContext, null);
  if (context === null) {
...
function usePopoverGroupContext() {
  return (0, import_vue25.inject)(PopoverGroupContext, null);
}
var PopoverPanelContext = Symbol("PopoverPanelContext");
function usePopoverPanelContext() {
  return (0, import_vue25.inject)(PopoverPanelContext, null);
}
var Popover = (0, import_vue25.defineComponent)({
  name: "Popover",
  props: {
    as: { type: [Object, String], default: "div" }
  },
  setup(props, { slots, attrs, expose }) {
    var _a;
    let internalPopoverRef = (0, import_vue25.ref)(null);
    expose({ el: internalPopoverRef, $el: internalPopoverRef });
    let popoverState = (0, import_vue25.ref)(1 /* Closed */);
    let button = (0, import_vue25.ref)(null);
    let beforePanelSentinel = (0, import_vue25.ref)(null);
    let afterPanelSentinel = (0, import_vue25.ref)(null);
    let panel = (0, import_vue25.ref)(null);
    let ownerDocument = (0, import_vue25.computed)(() => getOwnerDocument(internalPopoverRef));
    let isPortalled = (0, import_vue25.computed)(() => {
      var _a2, _b;
      if (!dom(button))
        return false;
      if (!dom(panel))
    ...
    let api = {
      popoverState,
      buttonId: (0, import_vue25.ref)(null),
      panelId: (0, import_vue25.ref)(null),
      panel,
      button,
      isPortalled,
      beforePanelSentinel,
    ...
    (0, import_vue25.provide)(PopoverContext, api);
    useOpenClosedProvider((0, import_vue25.computed)(() => match(popoverState.value, {
      [0 /* Open */]: 0 /* Open */,
      [1 /* Closed */]: 1 /* Closed */
    })));
    let registerBag = {
    ...
    (0, import_vue25.watchEffect)(() => registerPopover == null ? void 0 : registerPopover(registerBag));
    useEventListener((_a = ownerDocument.value) == null ? void 0 : _a.defaultView, "focus", (event) => {
      var _a2, _b;
    ...
    }, (0, import_vue25.computed)(() => popoverState.value === 0 /* Open */));
    return () => {
...
var PopoverButton = (0, import_vue25.defineComponent)({
  name: "PopoverButton",
  props: {
    as: { type: [Object, String], default: "button" },
    disabled: { type: [Boolean], default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let ownerDocument = (0, import_vue25.computed)(() => getOwnerDocument(api.button));
    ...
    let isWithinPanel = (0, import_vue25.computed)(() => panelContext === null ? false : panelContext.value === api.panelId.value);
    let elementRef = (0, import_vue25.ref)(null);
    ...
    let type = useResolveButtonType((0, import_vue25.computed)(() => ({ as: props.as, type: attrs.type })), elementRef);
    function handleKeyDown(event) {
      var _a, _b, _c, _d, _e;
      if (isWithinPanel.value) {
    ...
    return () => {
      ...
      return (0, import_vue25.h)(import_vue25.Fragment, [
        ...
        visible && !isWithinPanel.value && api.isPortalled.value && (0, import_vue25.h)(Hidden, {
          id: sentinelId,
          features: 2 /* Focusable */,
          "data-headlessui-focus-guard": true,
          as: "button",
...
var PopoverOverlay = (0, import_vue25.defineComponent)({
  name: "PopoverOverlay",
  props: {
    as: { type: [Object, String], default: "div" },
    static: { type: Boolean, default: false },
...
var PopoverPanel = (0, import_vue25.defineComponent)({
  name: "PopoverPanel",
  props: {
    as: { type: [Object, String], default: "div" },
    static: { type: Boolean, default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let ownerDocument = (0, import_vue25.computed)(() => getOwnerDocument(api.panel));
    ...
    (0, import_vue25.provide)(PopoverPanelContext, api.panelId);
    (0, import_vue25.watchEffect)(() => {
      var _a, _b;
      if (!focus)
        return;
      ...
      return render({
        ...
        slots: {
          ...
          default: (...args) => {
            var _a;
            return [
              (0, import_vue25.h)(import_vue25.Fragment, [
                visible.value && api.isPortalled.value && (0, import_vue25.h)(Hidden, {
...
var PopoverGroup = (0, import_vue25.defineComponent)({
  name: "PopoverGroup",
  props: {
    as: { type: [Object, String], default: "div" }
  },
  setup(props, { attrs, slots, expose }) {
    let groupRef = (0, import_vue25.ref)(null);
    let popovers = (0, import_vue25.shallowRef)([]);
    let ownerDocument = (0, import_vue25.computed)(() => getOwnerDocument(groupRef));
    ...
    (0, import_vue25.provide)(PopoverGroupContext, {
      registerPopover,
      unregisterPopover,
...
function useLabelContext() {
  let context = (0, import_vue26.inject)(LabelContext, null);
  if (context === null) {
...
function useLabels({
  ...
  let labelIds = (0, import_vue26.ref)([]);
  function register(value) {
  ...
  (0, import_vue26.provide)(LabelContext, { register, slot, name, props });
  return (0, import_vue26.computed)(() => labelIds.value.length > 0 ? labelIds.value.join(" ") : void 0);
}
var Label = (0, import_vue26.defineComponent)({
  name: "Label",
  props: {
    as: { type: [Object, String], default: "label" },
  ...
  setup(myProps, { slots, attrs }) {
    ...
    (0, import_vue26.onMounted)(() => (0, import_vue26.onUnmounted)(context.register(myProps.id)));
    return () => {
      let { name = "Label", slot = {}, props = {} } = context;
      let { id: id2, passive, ...theirProps } = myProps;
      let ourProps = {
        ...Object.entries(props).reduce((acc, [key, value]) => Object.assign(acc, { [key]: (0, import_vue26.unref)(value) }), {}),
        id: id2
      };
      if (passive) {
...
function useRadioGroupContext(component) {
  let context = (0, import_vue27.inject)(RadioGroupContext, null);
  if (context === null) {
...
var RadioGroup = (0, import_vue27.defineComponent)({
  name: "RadioGroup",
  emits: { "update:modelValue": (_value) => true },
  props: {
    as: { type: [Object, String], default: "div" },
  ...
  inheritAttrs: false,
  setup(props, { emit, attrs, slots, expose }) {
    let radioGroupRef = (0, import_vue27.ref)(null);
    ...
    let [value, theirOnChange] = useControllable((0, import_vue27.computed)(() => props.modelValue), (value2) => emit("update:modelValue", value2), (0, import_vue27.computed)(() => props.defaultValue));
    let api = {
      options,
      value,
      disabled: (0, import_vue27.computed)(() => props.disabled),
      firstOption: (0, import_vue27.computed)(() => options.value.find((option) => {
        if (option.propsRef.disabled)
          return false;
        return true;
      })),
      containsCheckedOption: (0, import_vue27.computed)(() => options.value.some((option) => api.compare((0, import_vue27.toRaw)(option.propsRef.value), (0, import_vue27.toRaw)(props.modelValue)))),
      compare(a, z) {
        if (typeof props.by === "string") {
          let property = props.by;
          return (a == null ? void 0 : a[property]) === (z == null ? void 0 : z[property]);
      ...
      change(nextValue) {
        ...
        if (props.disabled)
          return false;
        if (api.compare((0, import_vue27.toRaw)(value.value), (0, import_vue27.toRaw)(nextValue)))
          return false;
        let nextOption = (_a = options.value.find((option) => api.compare((0, import_vue27.toRaw)(option.propsRef.value), (0, import_vue27.toRaw)(nextValue)))) == null ? void 0 : _a.propsRef;
    ...
    (0, import_vue27.provide)(RadioGroupContext, api);
    useTreeWalker({
      container: (0, import_vue27.computed)(() => dom(radioGroupRef)),
      accept(node) {
    ...
    return () => {
      ...
      return (0, import_vue27.h)(import_vue27.Fragment, [
        ...name != null && value.value != null ? objectToFormEntries({ [name]: value.value }).map(([name2, value2]) => (0, import_vue27.h)(Hidden, compact({
          features: 4 /* Hidden */,
          key: name2,
          as: "input",
          type: "hidden",
...
var RadioGroupOption = (0, import_vue27.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let labelledby = useLabels({ name: "RadioGroupLabel" });
    let describedby = useDescriptions({ name: "RadioGroupDescription" });
    let optionRef = (0, import_vue27.ref)(null);
    let propsRef = (0, import_vue27.computed)(() => ({ value: props.value, disabled: props.disabled }));
    let state = (0, import_vue27.ref)(1 /* Empty */);
    expose({ el: optionRef, $el: optionRef });
    (0, import_vue27.onMounted)(() => api.registerOption({ id: props.id, element: optionRef, propsRef }));
    (0, import_vue27.onUnmounted)(() => api.unregisterOption(props.id));
    let isFirstOption = (0, import_vue27.computed)(() => {
      var _a;
      return ((_a = api.firstOption.value) == null ? void 0 : _a.id) === props.id;
    });
    let disabled = (0, import_vue27.computed)(() => api.disabled.value || props.disabled);
    let checked = (0, import_vue27.computed)(() => api.compare((0, import_vue27.toRaw)(api.value.value), (0, import_vue27.toRaw)(props.value)));
    let tabIndex = (0, import_vue27.computed)(() => {
      if (disabled.value)
        return -1;
      if (checked.value)
        return 0;
...
var SwitchGroup = (0, import_vue28.defineComponent)({
  name: "SwitchGroup",
  props: {
    as: { type: [Object, String], default: "template" }
  },
  setup(props, { slots, attrs }) {
    let switchRef = (0, import_vue28.ref)(null);
    ...
    (0, import_vue28.provide)(GroupContext, api);
    return () => render({ theirProps: props, ourProps: {}, slot: {}, slots, attrs, name: "SwitchGroup" });
  }
});
var Switch = (0, import_vue28.defineComponent)({
  name: "Switch",
  emits: { "update:modelValue": (_value) => true },
  props: {
    as: { type: [Object, String], default: "button" },
  ...
  inheritAttrs: false,
  setup(props, { emit, attrs, slots, expose }) {
    let api = (0, import_vue28.inject)(GroupContext, null);
    let [checked, theirOnChange] = useControllable((0, import_vue28.computed)(() => props.modelValue), (value) => emit("update:modelValue", value), (0, import_vue28.computed)(() => props.defaultChecked));
    function toggle() {
      theirOnChange(!checked.value);
    }
    let internalSwitchRef = (0, import_vue28.ref)(null);
    let switchRef = api === null ? internalSwitchRef : api.switchRef;
    let type = useResolveButtonType((0, import_vue28.computed)(() => ({ as: props.as, type: attrs.type })), switchRef);
    ...
    return () => {
      ...
      return (0, import_vue28.h)(import_vue28.Fragment, [
        name != null && checked.value != null ? (0, import_vue28.h)(Hidden, compact({
          features: 4 /* Hidden */,
          as: "input",
          type: "checkbox",
          hidden: true,
...
var FocusSentinel = (0, import_vue29.defineComponent)({
  props: {
    onFocus: {
      type: Function,
      required: true
  ...
  setup(props) {
    let enabled = (0, import_vue29.ref)(true);
    return () => {
      if (!enabled.value)
        return null;
      return (0, import_vue29.h)(Hidden, {
        as: "button",
        type: "button",
        features: 2 /* Focusable */,
        onFocus(event) {
...
function useTabsContext(component) {
  let context = (0, import_vue30.inject)(TabsContext, null);
  if (context === null) {
...
var TabGroup = (0, import_vue30.defineComponent)({
  name: "TabGroup",
  emits: {
    change: (_index) => true
  },
  ...
  setup(props, { slots, attrs, emit }) {
    var _a;
    let selectedIndex = (0, import_vue30.ref)((_a = props.selectedIndex) != null ? _a : props.defaultIndex);
    let tabs = (0, import_vue30.ref)([]);
    let panels = (0, import_vue30.ref)([]);
    let isControlled = (0, import_vue30.computed)(() => props.selectedIndex !== null);
    let realSelectedIndex = (0, import_vue30.computed)(() => isControlled.value ? props.selectedIndex : selectedIndex.value);
    ...
    let api = {
      selectedIndex: (0, import_vue30.computed)(() => {
        var _a2, _b;
        return (_b = (_a2 = selectedIndex.value) != null ? _a2 : props.defaultIndex) != null ? _b : null;
      }),
      orientation: (0, import_vue30.computed)(() => props.vertical ? "vertical" : "horizontal"),
      activation: (0, import_vue30.computed)(() => props.manual ? "manual" : "auto"),
      tabs,
      panels,
    ...
    (0, import_vue30.provide)(TabsContext, api);
    let SSRCounter = (0, import_vue30.ref)({ tabs: [], panels: [] });
    let mounted = (0, import_vue30.ref)(false);
    (0, import_vue30.onMounted)(() => {
      mounted.value = true;
    });
    (0, import_vue30.provide)(TabsSSRContext, (0, import_vue30.computed)(() => mounted.value ? null : SSRCounter.value));
    let incomingSelectedIndex = (0, import_vue30.computed)(() => props.selectedIndex);
    (0, import_vue30.onMounted)(() => {
      (0, import_vue30.watch)([incomingSelectedIndex], () => {
        var _a2;
    ...
    return () => {
      ...
      return (0, import_vue30.h)(import_vue30.Fragment, [
        tabs.value.length <= 0 && (0, import_vue30.h)(FocusSentinel, {
          onFocus: () => {
...
var TabList = (0, import_vue30.defineComponent)({
  name: "TabList",
  props: {
    as: { type: [Object, String], default: "div" }
  },
...
var Tab = (0, import_vue30.defineComponent)({
  name: "Tab",
  props: {
    as: { type: [Object, String], default: "button" },
    disabled: { type: [Boolean], default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let internalTabRef = (0, import_vue30.ref)(null);
    expose({ el: internalTabRef, $el: internalTabRef });
    (0, import_vue30.onMounted)(() => api.registerTab(internalTabRef));
    (0, import_vue30.onUnmounted)(() => api.unregisterTab(internalTabRef));
    let SSRContext = (0, import_vue30.inject)(TabsSSRContext);
    let mySSRIndex = (0, import_vue30.computed)(() => {
      if (SSRContext.value) {
    ...
    let myIndex = (0, import_vue30.computed)(() => {
      let myIndex2 = api.tabs.value.indexOf(internalTabRef);
      if (myIndex2 === -1)
        return mySSRIndex.value;
      return myIndex2;
    });
    let selected = (0, import_vue30.computed)(() => myIndex.value === api.selectedIndex.value);
    ...
    let ready = (0, import_vue30.ref)(false);
    ...
    let type = useResolveButtonType((0, import_vue30.computed)(() => ({ as: props.as, type: attrs.type })), internalTabRef);
    return () => {
      var _a;
...
var TabPanels = (0, import_vue30.defineComponent)({
  name: "TabPanels",
  props: {
    as: { type: [Object, String], default: "div" }
  },
...
var TabPanel = (0, import_vue30.defineComponent)({
  name: "TabPanel",
  props: {
    as: { type: [Object, String], default: "div" },
    static: { type: Boolean, default: false },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let internalPanelRef = (0, import_vue30.ref)(null);
    expose({ el: internalPanelRef, $el: internalPanelRef });
    (0, import_vue30.onMounted)(() => api.registerPanel(internalPanelRef));
    (0, import_vue30.onUnmounted)(() => api.unregisterPanel(internalPanelRef));
    let SSRContext = (0, import_vue30.inject)(TabsSSRContext);
    let mySSRIndex = (0, import_vue30.computed)(() => {
      if (SSRContext.value) {
    ...
    return () => {
      ...
      if (!selected.value && props.unmount && !props.static) {
        return (0, import_vue30.h)(Hidden, { as: "span", ...ourProps });
      }
      return render({
        ourProps,
        theirProps,
...
function hasTransitionContext() {
  return (0, import_vue31.inject)(TransitionContext, null) !== null;
}
function useTransitionContext() {
  let context = (0, import_vue31.inject)(TransitionContext, null);
  if (context === null) {
...
function useParentNesting() {
  let context = (0, import_vue31.inject)(NestingContext, null);
  if (context === null) {
    throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
  }
  return context;
...
function useNesting(done) {
  let transitionableChildren = (0, import_vue31.ref)([]);
  let mounted = (0, import_vue31.ref)(false);
  (0, import_vue31.onMounted)(() => mounted.value = true);
  (0, import_vue31.onUnmounted)(() => mounted.value = false);
...
var TransitionChild = (0, import_vue31.defineComponent)({
  props: {
    as: { type: [Object, String], default: "div" },
  ...
  setup(props, { emit, attrs, slots, expose }) {
    if (!hasTransitionContext() && hasOpenClosed()) {
      return () => (0, import_vue31.h)(TransitionRoot, {
        ...props,
    ...
    let container = (0, import_vue31.ref)(null);
    let state = (0, import_vue31.ref)("visible" /* Visible */);
    let strategy = (0, import_vue31.computed)(() => props.unmount ? 0 /* Unmount */ : 1 /* Hidden */);
    expose({ el: container, $el: container });
    ...
    (0, import_vue31.onMounted)(() => {
      ...
      (0, import_vue31.onUnmounted)(unregister2);
    });
    ...
    (0, import_vue31.onMounted)(() => {
      (0, import_vue31.watch)([show], (_oldValues, _newValues, onInvalidate) => {
        executeTransition(onInvalidate);
        initial.value = false;
      }, { immediate: true });
    });
    (0, import_vue31.provide)(NestingContext, nesting);
    useOpenClosedProvider((0, import_vue31.computed)(() => match(state.value, {
    ...
    return () => {
      ...
      let theirProps = {
        ...
        ...appear && show && env.isServer ? {
          class: (0, import_vue31.normalizeClass)([rest.class, ...enterClasses, ...enterFromClasses])
        } : {}
      };
      return render({
        theirProps,
...
var TransitionRoot = (0, import_vue31.defineComponent)({
  inheritAttrs: false,
  props: {
    as: { type: [Object, String], default: "div" },
    show: { type: [Boolean], default: null },
  ...
  setup(props, { emit, attrs, slots }) {
    let usesOpenClosedState = useOpenClosed();
    let show = (0, import_vue31.computed)(() => {
    ...
    let state = (0, import_vue31.ref)(show.value ? "visible" /* Visible */ : "hidden" /* Hidden */);
    let nestingBag = useNesting(() => {
      state.value = "hidden" /* Hidden */;
    });
    let initial = (0, import_vue31.ref)(true);
    let transitionBag = {
      show,
      appear: (0, import_vue31.computed)(() => props.appear || !initial.value)
    };
    (0, import_vue31.onMounted)(() => {
      (0, import_vue31.watchEffect)(() => {
        initial.value = false;
    ...
    (0, import_vue31.provide)(NestingContext, nestingBag);
    (0, import_vue31.provide)(TransitionContext, transitionBag);
    return () => {
      ...
      return render({
        ...
        slots: {
          ...slots,
          default: () => [
            (0, import_vue31.h)(_TransitionChild, {
              onBeforeEnter: () => emit("beforeEnter"),
              onAfterEnter: () => emit("afterEnter"),
              onBeforeLeave: () => emit("beforeLeave"),
              onAfterLeave: () => emit("afterLeave"),
